...
size_t tree_height(const heap_t *tree)
{
	...
	if (tree->left)
		height_le = 1 + tree_height(tree->left);

	if (tree->right)
		height_ri = 1 + tree_height(tree->right);

	if (height_le > height_ri)
		return (height_le);
	return (height_ri);
}
/**
...
size_t tree_size_h(const binary_tree_t *tree)
{
	...
	if (tree->left)
		height_le = 1 + tree_size_h(tree->left);

	if (tree->right)
		height_ri = 1 + tree_size_h(tree->right);
